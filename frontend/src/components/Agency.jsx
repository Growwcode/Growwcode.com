      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mt-10 grid items-center gap-14 sm:mt-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="mt-8 space-y-4">
              {VALUES.map((item) => (
                <div key={item.title} className="flex gap-4">
                  <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-navy text-sm font-bold text-white">
                    ✓
                  </div>
                  <div>
          ...
          <div className="flex flex-col items-center gap-8">
            <AgencyIllustration />
            <blockquote className="w-full rounded-2xl border-l-4 border-navy bg-white p-6 shadow-sm">
        ...
        <div className="mt-20">
          <h4 className="text-lg font-bold text-gray-900">Core expertise</h4>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {EXPERTISE.map((skill) => (
              <span
                key={skill}
                className="rounded-full bg-navy/10 px-5 py-2.5 text-sm font-medium text-navy"
              >
                {skill}
              </span>
            ))}
