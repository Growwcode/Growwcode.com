...
function IndustryVisual({ industry, index, visible, imageFirst }) {
  if (industry.image) {
    return (
      <div
        className={`industry-showcase group relative flex min-h-[280px] items-center justify-center py-4 sm:min-h-[320px] ${
  ...
  return (
    <article
      ...
      className={`scroll-mt-28 ${
        index === 0 ? 'pb-6 pt-4 lg:pb-8 lg:pt-6' : 'py-8 lg:py-10'
      }`}
    >
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-b from-brand-50 via-white to-white pb-16 pt-12 lg:pb-24 lg:pt-16">
        ...
        <div className="relative mx-auto mt-6 max-w-6xl space-y-2 px-6 lg:mt-8 lg:space-y-4 lg:px-8">
